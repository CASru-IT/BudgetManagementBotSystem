...
public class CancelBudgetRequestUseCaseTests
{
    [Fact]
    public async Task ExecuteAsync_WithValidInputs_UpdatesRequestStatusToApprovalCancelled()
    {
        const int groupId = 1;
        const int requestId = 1;
        const int changedByUserId = 2;

        var changedByUser = new User("Canceller", 11111UL, AccountRole.Accountant);
    ...
    [Fact]
    public async Task ExecuteAsync_WhenChangedByUserNotFound_ThrowsArgumentNullException()
    {
        const int groupId = 1;
        const int requestId = 1;
    ...
    public async Task ExecuteAsync_WithMultipleRequests_UpdatesOnlyTargetRequest()
    {
        ...
        request2.UpdateStatus(RequestStatus.Approved);
    ...
    [Fact]
    public async Task ExecuteAsync_WhenCancellerIsNotAccountant_ThrowsUnauthorizedAccessException()
    {
        const int groupId = 1;
        const int requestId = 1;
        const int changedByUserId = 2;

        var changedByUser = new User("Canceller", 11111UL, AccountRole.Admin);
        var requester = new User("Requester", 22222UL, AccountRole.Accountant);
        requester.ChangeGroupId(0);
        var group = new Group("Test Group");
